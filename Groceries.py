...
print("--------------")
print(f"THERE ARE " + str(products_count) + " PRODUCTS:")
print("--------------")
...
#shortcut for vertical column selection(used to comment all of those lines below)
# press shift and option and clicking or dragging all the way down 
#--------------
